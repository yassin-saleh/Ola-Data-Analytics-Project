...
The OLA Data Analyst Project is an end-to-end data analytics initiative focused on understanding and optimizing ride-booking operations for OLA in Bengaluru, India.

This project simulates a real-world analytics use case by analyzing 100,000 ride bookings collected over one month.
It provides actionable insights related to:
...
├── Overall.png                 # Dashboard Overview
├── Ratings.png                 # Ratings Dashboard
├── Cancellation.png            # Cancellation Analysis
├── Revenue.png                 # Revenue Dashboard
├── Vehicle Type.png            # Vehicle Type Analysis
└── Ola-Slideshub/              # Presentation Slides
...
Pickup_Location	Pickup location (Bengaluru areas)
...
Peak booking hours and daily demand
